...
> This is a good point, and one which we intend to discuss further in an upcoming paper based on Chapter 4. The idea comes from the balance of repulsive forces (which should be fairly constant, decaying with r^-12) and variable attractive forces (decaying with r^-6). It naturally follows that increasing the magnitude of the attractive term increases the depth of the potential well, while also decreasing the interatomic distance. It is probably true that there are limits to this approximation, however we have not encountered them.
...
> This is an excellent point. I have added DFT potential energy surface scans for a number of para substituents to quantify the this contribution. Unfortunately I cannot see a method to effectively untangle this contribution from the overall geometry. A note has been added to this effect. TODO
...
> A brief note had been added to explain this.
...
- Chapter. 6 (page 160): it is not clear what is meant by ‘libration of the nitro group’ (this is generally a term from the astronomy field).
  > Libration refers to a oscillating motion which in this case caused elongation of the thermal ellipsoids perpendicular to the plane of the ring. We feel this is a sufficiently common term in chemistry (common enough to merit a Wikipedia article), however I have added a qualifying note.
...
> Disorder can sometimes be modelled using highly restrained multipole models, however it is often found alongside other issues which preclude multipole refinement. In all cases, the quality was judged by residual electron density, taking into account disorder.
...
> These are shown with the characterisation data. TODO
...
> A diagram has been added to explain this.
...
> This is true, and we comment on this.

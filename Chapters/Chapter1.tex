...
An example of NBOs in a simple molecule is shown in \cref{fig:nbos}

\begin{figure}
    NBO FIGURE HERE???
    %\includegraphics[width=0.9\linewidth]{Figures/nbo-types.pdf}
    \caption{Natural Bond Orbitals of a DMF molecule.}
    \label{fig:nbos}
\end{figure}
...
\begin{figure}
    \includegraphics[width=0.35\linewidth]{Figures/dmf-molecule.pdf}
    \includegraphics[width=0.55\linewidth]{Figures/dmf-density.pdf}
...
\begin{figure}
    \includegraphics[width=0.65\linewidth]{Figures/dmf-gradient.pdf}
    \caption[Electron density gradient $\nabla\rho(\textbf{r})$ vector field of DMF.]{Electron density gradient $\nabla\rho(\textbf{r})$ vector field of DMF. All field lines (red) converge on the nuclei, and asymptotically approach the zero flux surfaces (black lines) which bound the QTAIM atoms. Bond critical points are shown as blue points.}

...
We were unable to correct for this in the periodic series describing the torsion, so the non-bonding parameter for the oxygen was reduced to 1.25 and 0.2.
...
Values of 1.96 and 0.2910 for the Lennard-Jones parameters $\sigma$ and $\varepsilon$ were used for selenium.

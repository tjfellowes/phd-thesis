...
\begin{table}
    ...
    \begin{tabular}{lllll}\toprule
        ...
        \bottomrule
    \end{tabular}
    \caption{Median geometric parameters for complexes with \cmpd{ebs}. DFT equilibrium values are given in brackets for comparison. DFT energies are derived from SAPT(DFT) (table S5). REDO}
    \label{tab:ebs-geom}
\end{table}

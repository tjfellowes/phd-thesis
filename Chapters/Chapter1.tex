...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{Figures/dmf-dens-contour.pdf}

    \includegraphics[width=0.85\linewidth]{Figures/dmf-dens-relief.pdf}
    \begin{picture}(0,0)
        \put(-10cm,19cm){\includegraphics[width=3cm]{Figures/dmf-molecule.png}}
    \end{picture}
...
\begin{figure}
    \includegraphics[width=0.85\linewidth]{Figures/dmf-grad.pdf}
...
\begin{figure}
    \includegraphics[width=0.85\linewidth]{Figures/dmf-lapl.pdf}
    \caption[Laplacian of the electron density $\nabla^{2}\rho(\textbf{r})$ of DMF.]{Laplacian}
    \label{fig:dmf-lapl}
\end{figure}
...
\begin{figure}
    \includegraphics[width=0.65\linewidth]{Figures/dmf-cp.png}
    \caption[Critical points of DMF.]{Critical points}
    \label{fig:dmf-cps}
\end{figure}

...
These take the form of one centre and two centre elements (lone pairs and bonding pairs respectively), which together form the optimal Lewis structure for a molecule.
The NBO scheme also provides a framework for non-Lewis features, such as non-valence electrons which are found in core NBOs, and hyperconjugation and delocalisation effects which manifest as departures from either full or zero occupancy of NBOs.
...
Energy Decomposition Analysis (EDA) encompasses a number of techniques that are concerned with dissecting energetic contributions to particular interactions.
It is most commonly applied to non-covalent interactions,

\subsubsection{Quantum Theory of Atoms In Molecules}
The Quantum Theory of Atoms In Molecules is a description of bonding that is complimentary to that of NBO

\begin{refsection}
    ...
    \ce{^{1}H}-NMR (499~MHz, \ce{CDCl3}) $\delta$ ppm 8.49 (1H, d, \textit{J} = 7.9~Hz, \ce{H^8}), 8.39 (1H, dd, \textit{J}\textsubscript{1} = 1.1~Hz, \textit{J}\textsubscript{2} = 8.0~Hz, \ce{H^1}), 7.91 (1H, d, \textit{J} = 7.9~Hz, \ce{H^{11}}), 7.88--7.84 (1H, m, \ce{H^{10}}), 7.80 (1H, d, \textit{J} = 8.0~Hz, \ce{H^4}), 7.76--7.70 (1H, m, \ce{H^3}), 7.63--7.54 (2H, m, \ce{H^{2/9}}).
    
    MS (ESI +ve) m/z 300.9873 (\ce{MH+}) \ce{C14H9N2OSe+} requires 300.9875 ($\Delta=0.66$~ppm).

\begin{refsection}
    ...
    \ce{^{1}H}-NMR (499~MHz, \ce{CDCl3}) $\delta$ ppm 8.49 (1H, d, \textit{J} = 7.9~Hz), 8.39 (1H, dd, \textit{J}\textsubscript{1} = 1.1~Hz, \textit{J}\textsubscript{2} = 8.0~Hz), 7.91 (1H, d, \textit{J} = 7.9~Hz), 7.88--7.84 (1H, m), 7.8 (1H, d, \textit{J} = 8.0~Hz), 7.76--7.7 (1H, m), 7.63--7.54 (2H, m).

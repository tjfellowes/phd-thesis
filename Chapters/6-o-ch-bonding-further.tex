...
The bond path is disrupted (the BCP and ring critical point coalesce and annihilate each other) by libration (oscillation about the \ce{C-N} bond) of the nitro group, thus its influence on the energy of the molecule is minimal.\autocite{Farrugia2006}
...
The more electron donating this group, the greater the double bond character of the \ce{C_{ar}-N_{nitro}} bond (\cref{fig:nitro-push-pull}), and so the coplanar geometry is more favoured.

\begin{figure}
    \centering
    \includegraphics[scale=0.74]{Figures/nitro-push-pull.eps}
    \caption[Resonance effects in \textit{para} substituted nitrobenzenes.]{The double bond character of the \ce{C_{ar}-N_{nitro}} bond is increased by electron donating substituents at the \textit{para} position.}\label{fig:nitro-push-pull}
\end{figure}
...
\ce{^{1}H}-NMR (499~MHz, \ce{CDCl3}) $\delta$ ppm 7.94 (1H, dd, \textit{J}\textsubscript{1} = 0.9~Hz, \textit{J}\textsubscript{2} = 8.2~Hz, \ce{H^{3}}), 7.77 (1H, d, \textit{J} = 8.5~Hz, \ce{H^6}), 7.55 (1H, t, \textit{J} = 7.4~Hz, \ce{H^5}), 7.03 (1H, t, \textit{J} = 7.7~Hz, \ce{H^4}), 2.76 (2H, t, \textit{J} = 6.4~Hz, \ce{H^{6'}}), 2.37 (2H, t, \textit{J} = 6.4~Hz, \ce{H^{2'}}), 1.83--1.71 (4H, m, \ce{H{3'/5'}}), 1.7--1.63 (2H, m, \ce{H^{4'}}).

\ce{^{13}C}-NMR (125~MHz, \ce{CDCl3}) $\delta$ ppm 166.9, 153.4, 137.1, 134.6, 125.5, 120.8, 116.9, 31.9, 27.0, 26.8, 25.8, 25.6.
...
\ce{^{1}H}-NMR (499~MHz, \ce{CDCl3}) $\delta$ ppm 8.05 (1H, d, \textit{J} = 9.4~Hz, \ce{H^3}), 6.91 (1H, d, \textit{J} = 2.7~Hz, \ce{H^6}), 6.25 (1H, dd, \textit{J}\textsubscript{1} = 2.7~Hz, \textit{J}\textsubscript{2} = 9.4~Hz, \ce{H^4}), 3.11 (6H, s, \ce{CH3}), 2.83 (2H, t, \textit{J} = 6.4~Hz, \ce{H^{6'}}), 2.39 (2H, t, \textit{J} = 6.4~Hz, \ce{H^{2'}}), 1.85--1.71 (4H, m, \ce{H{3'/5'}}), 1.7--1.61 (2H, m, \ce{H^{4'}}).

\ce{^{13}C}-NMR (125~MHz, \ce{CDCl3}) $\delta$ ppm 166.7, 156.3, 155.1, 128.5, 104.1, 96.4, 40.3, 32.0, 27.2, 27.0, 25.9, 25.6.
...
\ce{^{1}H}-NMR (499~MHz, \ce{CDCl3}) $\delta$ ppm 8.04 (1H, d, \textit{J} = 9.3~Hz, \ce{H^3}), 7.16 (1H, d, \textit{J} = 2.4~Hz, \ce{H^6}), 6.45 (1H, dd, \textit{J}\textsubscript{1} = 2.6~Hz, \textit{J}\textsubscript{2} = 9.4~Hz, \ce{H^5}), 3.86 (4H, t, \textit{J} = 4.7~Hz, \ce{H^{2'/6'}}), 3.37 (4H, t, \textit{J} = 4.8~Hz, \ce{H^{3'/5'}}), 2.82 (2H, t, \textit{J} = 6.4~Hz, \ce{H^{6''}}), 2.5 (1H, t, \textit{J} = 6.0~Hz, \ce{H^{4''}}), 2.39 (2H, t, \textit{J} = 6.2~Hz, \ce{H^{2''}}), 2.21 (1H, t, \textit{J} = 6.4~Hz, \ce{H^{4''}}), 1.85--1.71 (4H, m, \ce{H^{3''/5''}}).

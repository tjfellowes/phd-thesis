...
\ce{^{1}H}-NMR (499~MHz, \ce{CDCl3}) $\delta$ ppm 7.94 (1H, dd, \textit{J}\textsubscript{1} = 0.9~Hz, \textit{J}\textsubscript{2} = 8.2~Hz), 7.77 (1H, d, \textit{J} = 8.5~Hz), 7.55 (1H, t, \textit{J} = 7.4~Hz), 7.03 (1H, t, \textit{J} = 7.7~Hz), 2.76 (2H, t, \textit{J} = 6.4~Hz), 2.37 (2H, t, \textit{J} = 6.4~Hz), 1.83--1.71 (4H, m), 1.7--1.63 (2H, m).
...
\ce{^{1}H}-NMR (499~MHz, \ce{CDCl3}) $\delta$ ppm 8.05 (1H, d, \textit{J} = 9.4~Hz), 6.91 (1H, d, \textit{J} = 2.7~Hz), 6.25 (1H, dd, \textit{J}\textsubscript{1} = 2.7~Hz, \textit{J}\textsubscript{2} = 9.4~Hz), 3.11 (6H, s), 2.83 (2H, t, \textit{J} = 6.4~Hz), 2.39 (2H, t, \textit{J} = 6.4~Hz), 1.85--1.71 (4H, m), 1.7--1.61 (2H, m).

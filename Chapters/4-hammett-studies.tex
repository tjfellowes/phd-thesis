...
We therefore prepared co-crystals with \cmpd{py.pyrrol,py.morph}, which are slightly stronger and weaker bases than DMAP respectively.
...
\begin{figure}
  ...
  \caption[Experimental vs calculated electron density.]{Experimental vs calculated electron density. The line $\rho_\text{BCP, exp} = \rho_\text{BCP, calc}$ is shown.}\label{fig:qtaim-calc-exp}
\end{figure}
...
Fortunately, excellent agreement was obtained (\cref{fig:qtaim-calc-exp}).
...
\begin{figure}
  \centering
  \includegraphics[width=0.7\linewidth]{Figures/hammett-dmap-p.eps}
...
\begin{figure}
\centering
\includegraphics[width=0.7\linewidth]{Figures/hammett-pyrrol-p.eps}
...
\begin{figure}
\centering
\includegraphics[width=0.7\linewidth]{Figures/hammett-morph-p.eps}
\caption[Hammett plots of endocyclic \ce{Se-N} bond length and \ce{Se\cdots N} Ch-bond length of ebselen derivatives complexed with \refcmpd{py.morph}.]{Hammett plots of endocyclic \ce{Se-N} bond length and \ce{Se\cdots N} Ch-bond length of ebselen derivatives complexed with \refcmpd{py.morph}. The line is described by the equation $\mathrm{r}(\ce{Se-N}) = (1.967(3) + 0.036(9) \times \sigma_\text{p})$~\AA~($R^2=0.7386$) and $\mathrm{r}(\ce{Se\cdots N}) = (2.400(7) - 0.13(2) \times \sigma_\text{p})$~\AA~($R^2=0.8522$).}\label{fig:hammett-morph-para}
\end{figure}
...
\begin{figure}
  \centering
  \includegraphics[width=0.7\linewidth]{Figures/hammett-dmap-m.eps}
...
\begin{figure}
\centering
\includegraphics[width=0.7\linewidth]{Figures/hammett-pyrrol-m.eps}
...
\begin{figure}
\centering
\includegraphics[width=0.7\linewidth]{Figures/hammett-morph-m.eps}
\caption[Hammett plots of endocyclic \ce{Se-N} bond length and \ce{Se\cdots N} Ch-bond length of ebselen derivatives complexed with \refcmpd{py.morph}.]{Hammett plots of endocyclic \ce{Se-N} bond length and \ce{Se\cdots N} Ch-bond length of ebselen derivatives complexed with \refcmpd{py.morph}. The line is described by the equation $\mathrm{r}(\ce{Se-N}) = (1.963(5) + 0.04(2) \times \sigma_\text{m})$~\AA~($R^2=0.4620$) and $\mathrm{r}(\ce{Se\cdots N}) = (2.42(1) - 0.18(4) \times \sigma_\text{m})$~\AA~($R^2=0.7438$).}\label{fig:hammett-morph-meta}
\end{figure}
...
The electron density can be see to be somewhat concentrated in the covalent \ce{C-C} bonds, but less so in the Ch-bond.
...
A similar experiment was conducted by \citeauthor[]{Daolio2020} using hexamethylphosphoramide (HMPA) as the Lewis base, and the binding energy was found to be 0.910~kcal/mol, which is in good agreement with our results.\autocite{Daolio2020}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{Figures/hammett-dmap-nmr.eps}
...
As it happens, DFT calculations indicate that the Ch-bond through the oxygen is some 8.7~kcal/mol more stable than through the nitrogen, however this does not invalidate our experiment.

%O = -3468.501515 -2,176,484.7006625 kcal/mol
%N = -3468.487708 -2,176,476.03677 kcal/mol

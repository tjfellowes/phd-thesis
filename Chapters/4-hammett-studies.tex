...
\end{subfigure}
\caption[Hammett plots of endocyclic \ce{Se-N} bond length and \ce{Se\cdots N} Ch-bond length of ebselen derivatives complexed with various Lewis bases ($\sigma_\text{p}$).]{In all Hammett plots, the upper line represents the \ce{Se\cdots N} Ch-bond distance, and the lower line represents the endocyclic \ce{Se-N} bond length.}
\end{figure}
...
\end{subfigure}
\caption[Hammett plots of endocyclic \ce{Se-N} bond length and \ce{Se\cdots N} Ch-bond length of ebselen derivatives complexed with various Lewis bases ($\sigma_\text{m}$).]{In all Hammett plots, the upper line represents the \ce{Se\cdots N} Ch-bond distance, and the lower line represents the endocyclic \ce{Se-N} bond length.}
\end{figure}

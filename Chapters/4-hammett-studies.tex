...
The benzisoselenazolinone derivatives \cmpd[merge=false,compress=false]{ebs,ebs.{4no2,4cn,4cf3,4br,4co2et,4me,4ome,4oet}} were prepared by the reaction of substituted anilines with the dichloride of \cmpd{diselenide}, which i ultimately derived from anthranilic acid (\cref{sch:ebs-synthesis}).
...
Fortunately, excellent agreement was obtained ($R^2 = 0.8660$, \cref{fig:qtaim-calc-exp}).
...
\begin{figure}
    ...
    \caption[Solid state IR spectrum of \refcmpd{ebs.4oet}$ \cdot $DMAP.]{Solid state IR spectrum of \refcmpd{ebs.4oet}$ \cdot $DMAP in gray. The spectrum of the pure \refcmpd{ebs.4oet} is shown in black, which contains only one molecule in the asymmetric unit.}\label{fig:ebs-4oet-dmap-ir}
\end{figure}
...
All experiments were performed by ionising the sample in methanol via ESI into a Thermo Scientific linear ion trap quadrupole (LTQ) spectrometer, at a concentration of 1~m\textsc{M} and a rate of 5~$\mu\text{L}\cdot\text{min}^-{1}$.
An ESI voltage of 4.5~kV was used, and the sheath gas and lenses were tuned to optimise the signal of the precursor ion.

We initially injected an equimolar mixture of DMAP and ebselen \cmpd{ebs}, and isolated an ion of m/z 398.08~a.m.u.

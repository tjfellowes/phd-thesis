...
Pale yellow crystals, m.p. 285.7--287.0\degree{}C, yield 52\%.
...
\ce{^{13}C}-NMR (151~MHz, \ce{\textit{d}6}-DMSO) $ \delta $ ppm 166.26, 147.26, 143.66, 139.42, 133.21, 129.46, 128.57, 126.86, 126.83, 125.35, 123.77.

MS (ESI +ve) m/z 401.0005 (\ce{M + Na+} + acetone) \ce{C16H14N2NaO4Se+} requires 401.00110 ($ \Delta =1.52$~ppm).

\cmpd{ebs.4no2}$ \cdot $DMAP m.p. ???\degree{}C.

...
\begin{figure}
    \includegraphics[width=\linewidth]{Figures/dna_oligo.png}
...
A shift in absorbance is not readily apparent at such low DNA concentrations, so the experiment was repeated using 2~m\textsc{m}bp, and the resulting spectra are shown in \cref{fig:ebshoe-ctdna-hiconc}.
At this concentration, we observed precipitation of the ligand and DNA, which can be seen in the boradly absorbing tail in the spectra.

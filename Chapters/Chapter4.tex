...
\begin{scheme}
    ...
    \replacecmpd{ebs-thio.ph,ebs.ph}
    \includegraphics[scale=0.74]{Figures/ebs-thio-ph-synthesis.eps}
    \caption{Synthesis of \refcmpd{ebs-thio.ph} (X=\ce{S}) and \refcmpd{ebs.ph} (X=\ce{Se}).}
...
\cmpd*{rhs-bromo-2py-pmb}
\setcmpdlabel{rhs-bromo-2py-pmb}{\cmpdplain{rhs-bromo-2py}$\cdot$\textmd{PMB}}
We suspected that the benzimidazole proton may be competing with the amidic proton in the benzisothiazolinone ring, as it is substantially more acidic (pKa???), so we protected it using \emph{p}-methoxy benzyl chloride to give \cmpd{rhs-bromo-2py-pmb} (\cref{sch:rhs-protection}).
...
\cmpd*{rhs-bromo-ph-pmb}
\setcmpdlabel{rhs-bromo-ph-pmb}{\cmpdplain{rhs-bromo-ph}$\cdot$\textmd{PMB}}
\cmpd*{ebs-thio-rhs}
\cmpd*{ebs-thio-rhs-pmb}
\setcmpdlabel{ebs-thio-rhs-pmb}{\cmpdplain{ebs-thio-rhs}$\cdot$\textmd{PMB}}
\cmpd*{ebs-rhs}
\cmpd*{ebs-rhs-pmb}
\setcmpdlabel{ebs-rhs-pmb}{\cmpdplain{ebs-rhs}$\cdot$\textmd{PMB}}
We therefore prepared the phenyl derivative \cmpd{rhs-bromo-ph} by the same method, and protected it similarly to give both isomers of \cmpd{rhs-bromo-ph-pmb}.
This gave the desired coupling product \cmpd{ebs-thio-rhs-pmb} as a mixture of isomers, from of which we obtained a single crystal structure (\cref{sch:ebs-thio-rhs-synthesis} and \cref{fig:ebs-thio-rhs-pmb-xray}).
We were also able to prepare the benzisoselenazolinone derivative \cmpd{ebs-rhs-pmb} as a pair of isomers.
...
\begin{scheme}
    ...
    \replacecmpd{ebs-ebs}
    \caption{Synthesis of bis-benzisoselenazolinone Hoechst analogue \refcmpd{ebs-eb}.}

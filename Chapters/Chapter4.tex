...
\begin{scheme}
    \replacecmpd{ebs-thio.h,ebs.h}
    \replacecmpd{ebs-thio.ph,ebs}
    \includegraphics[scale=0.74]{Figures/ebs-thio-ph-synthesis.eps}
    \caption{Synthesis of \refcmpd{ebs-thio.ph} (X=\ce{S}) and \refcmpd{ebs} (X=\ce{Se}).}
...
This gave the desired coupling product \cmpd[sub-counter-format=pg]{ebs-thio-rhs.pmb} as a mixture of isomers, from one of which we obtained a single crystal structure (\cref{sch:ebs-thio-rhs-synthesis} and \cref{fig:ebs-thio-rhs-pmb-xray}).
...
\begin{scheme}
    \replacecmpd{ebs.h,ebs-thio.h}
    \replacecmpd{rhs-bromo-ph.pmb}
    \replacecmpd{ebs-rhs.pmb,ebs-thio-rhs.pmb}
    \includegraphics[scale=0.74]{Figures/ebs-thio-rhs-synthesis.eps}
    \caption{Synthesis of \refcmpd{ebs-rhs.pmb} (X=\ce{Se}) \refcmpd{ebs-thio-rhs.pmb} (X=\ce{S}).}
    \label{sch:ebs-thio-rhs-synthesis}
\end{scheme}

\begin{figure}
    \includegraphics[width = 0.8\linewidth]{Figures/ebs-thio-rhs-pmb-xray.pdf}
    \caption{X-ray crystal structure of one isomer of \refcmpd{ebs-thio-rhs.pmb}.}
...
\begin{figure}
    ...
    %\includegraphics[width=0.8\linewidth]{Figures/hoechst-fluoresence.pdf}
    \caption{Visible fluoresence of Hoechst derivatives methylproamine, M2PB \refcmpd{m2pb} and benzisoselenazolinone \refcmpd{ebs-rhs}.}

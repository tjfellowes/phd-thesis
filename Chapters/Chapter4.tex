...
Initial targets \cmpd{ebs-rhs,bim-ebs,ebs-ebs} were identified as likely minor groove binders, based on their similarity to the bis-benzimidaozles used previously in the group.
Bis-benzisoselenazolinone \cmpd{ebs-ebs} was particularly interesting, as it has the potential to be a completely H-bond free minor groove binder.
...
\begin{scheme}
    ...
    \replacecmpd{ebs-rhs-2py}
    \includegraphics[scale=0.8]{Figures/ebs-synthesis3.eps}
    \caption[Proposed synthesis of \refcmpd{ebs-rhs-2py}]{Proposed synthesis of precursor \refcmpd{ebs-rhs-2py}. a) \ce{SOCl2}, b) 2-nitro-1,4-benzenediamine, \ce{Et3N}, THF, c) Picolinic acid, TCBC/DMAP, \ce{Et3N}, d) [H], \ce{H+}.}
...
Rather than investigate other pathways to this compound (such as the use of coupling agents), we decided to simplify the system to a phenyl ring, as this had previously been shown to bind to DNA.
We therefore formed \cmpd{rhs-nitro-amide} in excellent yield, which underwent a dehydrocyclisation in the presence of the strong Lewis acid \ce{BF3\cdot OEt2} to form \cmpd{rhs-nitro}.

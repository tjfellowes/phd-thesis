...
\ce{^{1}H}-NMR spectra were referenced to residual solvent peaks; residual chloroform (7.26~ppm) in \textit{d}-chloroform or residual \textit{d}5-DMSO (2.50~ppm) in \textit{d}6-DMSO.\@

...
Nuclear magnetic resonance (NMR) spectra for \ce{^{1}H} and \ce{^{13}C} nuclei were recorded as solutions in the stated solvent at ambient temperature (25\degree{}C) using an Agilent 400-MR operating at 399.94~MHz and 100.58~MHz or an Agilent DD2 system operating at 499.62~MHz and 125.6~MHz, or 600~MHz and 150~MHz. 
\ce{^{1}H}-NMR spectra were referenced to residual solvent peaks; residual chloroform (7.26~ppm) in \textit{d}-chloroform, residual \textit{d}5-DMSO (2.50~ppm) in \textit{d}6-DMSO.\@

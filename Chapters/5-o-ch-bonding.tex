...
\begin{figure}
	\centering
	\includegraphics[width=0.6\linewidth]{Figures/oxime-bond-params.pdf}
...
\ce{^{1}H}-NMR (600~MHz, \ce{CDCl3}) $\delta$ ppm 8.83 (1H, d, \textit{J} = 2.3~Hz), 8.37 (1H, dd, \textit{J}\textsubscript{1} = 2.3~Hz, \textit{J}\textsubscript{2} = 9.4~Hz), 7.94 (1H, d, \textit{J} = 9.4~Hz), 2.73 (2H, t, \textit{J} = 6.4~Hz), 2.38 (2H, t, \textit{J} = 6.3~Hz), 1.83--1.7 (4H, m), 1.68--1.63 (2H, m).
...
\ce{^{1}H}-NMR (499~MHz, \ce{CDCl3}) $\delta$ ppm 8.89 (1H, d, \textit{J} = 2.7~Hz), 8.41 (1H, dd, \textit{J}\textsubscript{1} = 2.7~Hz, \textit{J}\textsubscript{2} = 9.4~Hz), 7.95 (1H, d, \textit{J} = 9.4~Hz), 2.21 (3H, s), 2.12 (3H, s).

...
\begin{figure}
	...
	\caption{Geometric parameters indicated in \cref{tab:oxime-bond-params}.}\label{fig:oxime-bond-params}
\end{figure}

\subsection{Structural effects attributable to the Ch-bond}
\begin{table}
\centering
\caption[Selected geometric parameters of oximes \refcmpd{dimethylcyclohexanone-oxime-dnp}, \refcmpd{cyclohexanone-oxime-dnp} and \refcmpd{acetone-oxime-dnp}.]{Selected geometric parameters of oximes \refcmpd{dimethylcyclohexanone-oxime-dnp}, \refcmpd{cyclohexanone-oxime-dnp} and \refcmpd{acetone-oxime-dnp}. The two geometries in the asymmetric unit of \refcmpd{cyclohexanone-oxime-dnp} are indicated as \refcmpd{cyclohexanone-oxime-dnp}a and \refcmpd{cyclohexanone-oxime-dnp}b.}\label{tab:oxime-bond-params}
\small
...
This gives an expected bond length of 1.448~\AA\ vs the measured bond length 1.489(2)~\AA\ ($\Delta = 0.041$~\AA{}; 13.7$\sigma$).
...
The difference in bond lengths between them is significant (1.445(2)~\AA\ vs 1.433(2)~\AA, $\Delta = 0.012$~\AA{}; 6$\sigma$), and the same trend is observed as in \cmpd{dimethylcyclohexanone-oxime-dnp}.
...
The oxime bond lengths differ significantly between \cmpd{cyclohexanone-oxime-dnp} and \cmpd{acetone-oxime-dnp} (1.4556(7)--1.4522(7) vs 1.4480(7)~\AA, $\Delta = 0.0042$~\AA{}; 6$\sigma$), supporting the suggestion that the n(O)$\rightarrow \sigma^{\star}$(\ce{O-N}) orbital delocalisation plays a role in these Ch-bonds.
...
\ce{^{1}H}-NMR (600~MHz, \ce{CDCl3}) $\delta$ ppm 8.83 (1H, d, \textit{J} = 2.3~Hz, \ce{H^3}), 8.37 (1H, dd, \textit{J}\textsubscript{1} = 2.3~Hz, \textit{J}\textsubscript{2} = 9.4~Hz, \ce{H^5}), 7.94 (1H, d, \textit{J} = 9.4~Hz, \ce{H^6}), 2.73 (2H, t, \textit{J} = 6.4~Hz, \ce{H^{2'}}), 2.38 (2H, t, \textit{J} = 6.3~Hz, \ce{H^{2'}}), 1.83--1.7 (4H, m, \ce{H{3'/5'}}), 1.68--1.63 (2H, m, \ce{H^{4'}}).

\ce{^{13}C}-NMR (151~MHz, \ce{CDCl3}) $\delta$ ppm 164.6, 153.0, 135.5, 131.0, 124.6, 117.3, 112.4, 27.0, 22.4.

MS (ESI +ve) m/z 280.0928 (\ce{M + H^+}) \ce{C12H14N3O5+} requires 280.0928 ($ \Delta = 0$~ppm).


Acetone oxime \cmpd{acetone-oxime-dnp} was isolated as a pale yellow powder, yield 72\%, m.p. 88.5--88.9\degree~C.

\ce{^{1}H}-NMR (499~MHz, \ce{CDCl3}) $\delta$ ppm 8.89 (1H, d, \textit{J} = 2.7~Hz, \ce{H^3}), 8.41 (1H, dd, \textit{J}\textsubscript{1} = 2.7~Hz, \textit{J}\textsubscript{2} = 9.4~Hz, \ce{H^5}), 7.95 (1H, d, \textit{J} = 9.4~Hz, \ce{H^6}), 2.21 (3H, s, \ce{H^{1'}}), 2.12 (3H, s, \ce{H^{3'}}).

\ce{^{13}C}-NMR (125~MHz, \ce{CDCl3}) $\delta$ ppm 164.4, 157.4, 140.5, 135.8, 129.3, 122.1, 117.2, 21.5, 17.4.

MS (ESI +ve) m/z 240.0614 (\ce{M + H^+}) \ce{C9H10N3O5+} requires 240.0615 ($ \Delta = 0.42$~ppm).

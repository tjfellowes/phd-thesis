...
\subsubsection{Measurement of chemical shift anisotropy}
...
\begin{table}
  ...
  \begin{tabular}{llll}
    \toprule
    Complex                     & $\delta_{11}$ & $\delta_{22}$ & $\delta_{33}$ \\\midrule
    \cmpd{ebs.4ome}$\cdot$DMAP\footnote{Site a}  & 1569.77       & 467.30        & 466.97        \\  
    \cmpd{ebs.4ome}$\cdot$DMAP\footnote{Site b}  & 1602.10       & 499.63        & 499.29        \\  
    \cmpd{ebs.ph}$\cdot$DMAP    & 1612.44       & 572.59        & 408.71        \\  
    \cmpd{ebs.4no2}$\cdot$DMAP  & 1609.42       & 497.11        & 476.34        \\\bottomrule
  \end{tabular}
...
As the crystal was too big to mount on the diffractometer, two faces were marked with different coloured pens, then a small fragment was removed from the crystal.

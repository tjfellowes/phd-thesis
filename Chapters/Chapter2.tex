...
\begin{scheme}
  ...
  \caption[Synthesis of benzisoselenazolone derivatives.]{Synthesis of benzisoselenazolone derivatives. a) 1. \ce{NaNO2}, \ce{HCl}, 0\degree C; 2. \ce{Na2Se2}, \ce{NaOH}, rt, 1~h, 37\%; b) 1. \ce{SOCl2}, cat. DMF, reflux, 1.5~h; 2. \ce{ArNH2}, TEA, MeCN, rt, 2~h, 14--67\%.}
...
\begin{figure}
    ...
    \caption[Solid state IR spectrum of \refcmpd{ebs.4oet}$\cdot$DMAP.]{Solid state IR spectrum of \refcmpd{ebs.4oet}$\cdot$DMAP. The spectrum of the pure \refcmpd{ebs.4oet} is shown in gray, which contains only one molecule in the asymmetric unit.}
...
This is obviously unphysical, and typical basis sets are not large enough to accomodate these non-atom centered perturbations.
...
This can be contrasted to the chemical shift of the non-complexed selen\-ium (\cref{fig:77se-tensor-ebs}).
...
\begin{figure}
  ...
  \end{picture}
  \caption{\ce{^{77}Se} NMR spectrum of a single crystal of \refcmpd{ebs}$\cdot$DMAP in the orientation depicted in the inset.}
...
\begin{figure}
  ...
  \end{picture}
  \caption[\ce{^{77}Se} NMR spectrum of a single crystal of \refcmpd{ebs}$\cdot$DMAP in the orientation depicted in the inset.]{\ce{^{77}Se} NMR spectrum of a single crystal of \refcmpd{ebs}$\cdot$DMAP in the orientation depicted in the inset. The smaller satellite signals are due to slightly misaligned crystals in the sample holder. This also explains the poorer signal to noise ratio of the main peak.}
...
\begin{figure}
  ...
  \caption[UV-Vis titration of \refcmpd{ebs} with DMAP.]{UV-Vis titration of \refcmpd{ebs} with DMAP. The pure soluution of \refcmpd{ebs} is shown in red, with increasing concentrations of DMAP in green.}
  \label{fig:ebs-dmap-uv-titration}
\end{figure}

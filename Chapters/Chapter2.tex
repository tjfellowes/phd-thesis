...
\caption{Synthesis of benzisoselenazolone derivatives \refcmpd[merge=false,compress=false]{ebs}.}
...
\begin{figure}
  ...
  REDO
  \includegraphics[width=0.8\linewidth]{Figures/ebs-dmap-hahnecho-77se.pdf}
  \caption{\ce{^{77}Se} NMR spectrum of a single crystal of \refcmpd{ebs}$\cdot$DMAP in the orientation depicted in \cref{fig:ebs-ph-dmap-magfield-index2}.}
...
\begin{figure}
  ...
  \caption{Experimentally determined chemical shift tensor for \refcmpd{ebs}$\cdot$DMAP. Compare with the calculated tensor in \cref{fig:77se-tensor-ebs-dmap}.}

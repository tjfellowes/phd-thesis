...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth]{fig/dimer-dmap-py-xray.pdf}
...
Compounds \cmpd{py.pyrrol,py.pip,py.morph} were therefore synthesised by treating 4-chloropyridine hydrochloride with 2 equivalents of the appropriate base (\ref{sch:base-synthesis}).

\begin{scheme}
\centering
\replacecmpd{py.pyrrol,py.pip,py.morph}
\includegraphics[scale=0.8]{Figures/base-synthesis.eps}
\caption{Synthesis of Lewis bases \refcmpd{py.pyrrol,py.pip,py.morph}.}
\label{sch:base-synthesis}
\end{scheme}

The benzisoselenazolone derivatives \cmpd{ebs.ph,ebs.4no2,ebs.4cn,ebs.4cf3,ebs.4br,ebs.4co2et,ebs.4me,ebs.4ome,ebs.4oet} were prepared by the reaction of substituted anilines with a selenenyl chloride intermediate, ultimately derived from anthranilic acid (\ref{sch:ebs-synthesis}).
The one-pot selenocyclisation reaction used in the previous chapter often did not tolerate the various functional groups on the aryl ring.
...
\end{tabular}}
\caption{Synthesis of benzisoselenazolone derivatives \refcmpd{ebs.ph,ebs.4no2,ebs.4cn,ebs.4cf3,ebs.4br,ebs.4co2et,ebs.4me,ebs.4ome,ebs.4oet}.}
...
The structural parameters are given in \ref{tab:bondlengths2}.
...
\begin{table}
  ...
  \tablefit{\begin{tabular}{lllllll}
    ...
    \cmpd{ebs.ph}$\cdot$DMAP     & 2.371(1) & 1.968(1) & 1.896(1) & 1.358(2) & 174.18(4) & 173.51(6) \\
    \cmpd{ebs.4no2}$\cdot$DMAP   & 2.240(3) & 1.967(2) & 1.883(2) & 1.340(2) & 174.27(9) & 176.8(1)  \\
    \cmpd{ebs.4cn}$\cdot$DMAP    & 2.301(1) & 1.997(1) & 1.899(2) & 1.368(2) & 174.79(5) & 167.57(6) \\
    \cmpd{ebs.4cn}$\cdot$DMAP\footnote{\label{fn:solvate}DCM solvate}\textsuperscript{,\ref{fn:enva}}  & 2.254(2) & 2.019(2) & 1.902(1) & 1.366(2) & 174.46(6) & 176.33(7) \\
    \cmpd{ebs.4cn}$\cdot$DMAP\textsuperscript{\ref{fn:solvate},\ref{fn:envb}}  & 2.308(2) & 1.993(1) & 1.901(1) & 1.372(2) & 174.93(5) & 167.85(7) \\
    \cmpd{ebs.4cf3}$\cdot$DMAP   & 2.3347(9) & 1.9855(9) & 1.899(1) & 1.372(1) & 175.24(4) & 162.65(5) \\
    \cmpd{ebs.4br}$\cdot$DMAP    & 2.3215(7) & 1.9840(7) & 1.9021(8) & 1.362(1) & 173.85(3) & 173.56(4) \\
    ...
    \cmpd{ebs.4oet}$\cdot$DMAP   & \\\\
    
    \cmpd{ebs.ph}$\cdot$\cmpd{py.pyrrol}     & \\
    ...
    \cmpd{ebs.4br}$\cdot$\cmpd{py.pyrrol}    & 2.319(2) & 1.981(2) & 1.895(1) & 1.362(2) & 174.57(6) & 174.60(8) \\
    ...
    \cmpd{ebs.ph}$\cdot$\cmpd{py.morph}     & \\
    ...
    \cmpd{ebs.4br}$\cdot$\cmpd{py.morph}    & 2.381(2) & 1.975(2) & 1.905(2) & 1.367(2) & 173.84(6) & 174.97(8) \\
...
PLOTS OF VARIOUS BOND LENGTHS WITH HAMMETT PARAMETERS
...
Interactions which have a charge-transfer component (such as Ch-bonding) can give rise to strong absorbances attributable to the n $\rightarrow \pi^{\star}$ transition.\autocite{Blackstock1987}
...
Furthermore, a \ce{N+ -H\cdots O} H bonds are very strong (in excess of 15~kcal/mol)\autocite{Emsley1980}, which is likely to outcompete Ch-bonding, with estimated bond enthalpies of <~10~kcal/mol in the gas phase.
...
\begin{figure}
    \centering
    \includegraphics{Figures/ebs-tcid.png}
...
\subsubsection{Preparation of bis(2-carboxyphenyl)diselenide \refcmpd{diselenide}}
...
\subsubsection{Preparation of 2-(chlorocarbonyl)phenylselenyl chloride \refcmpd{dichloride}}
...
\subsubsection{General procedure for the preparation of benzisoselenazolinone derivatives \refcmpd{ebs.ph,ebs.4no2,ebs.4cn,ebs.4cf3,ebs.4br,ebs.4co2et,ebs.4ome,ebs.4oet}}
...
Pale yellow crystals, xx\%.

\paragraph{4-Cyano ebselen \refcmpd{ebs.4cn}}
Colourless crystals, xx\%.

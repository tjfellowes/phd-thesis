...
In solution, the \ce{^{77}Se} resonance is found aroud 900~ppm relative to dimethylselenide ($\delta=$0~ppm), and appears as one singlet due to the thermal averaging of all environments.
...
DETERMINATION OF ANISOTROPIC CHEMICAL SHIFT TENSOR

...
\begin{figure}
  \centering
  \includegraphics[width=0.9\linewidth]{Figures/hammett-dmap-para.eps}
...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth]{Figures/hammett-pyrrol-para.eps}
...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth]{Figures/hammett-morph-para.eps}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\linewidth]{Figures/hammett-dmap-meta.eps}
...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth]{Figures/hammett-pyrrol-meta.eps}
...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth]{Figures/hammett-morph-meta.eps}
...
Crystal packing forces (the sum of weak interactions such as \ce{C-H}/$\pi$, $\pi /\pi$ and \ce{C-H}/O interactions) are commonly accepted to be in the range of 1--2~kcal$ \cdot $mol$^{-1}$, so it is perhaps not surprising that the Ch-bond is deformed by the crystal environment.\autocite{Dunitz1988}

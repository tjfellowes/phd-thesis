...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{Figures/4ome-ebs.dmap.eps}
...
The aromatic region of the solid state \ce{^{13}C} spectrum is shown in \ref{fig:cpmas-sol-13c}, overlaid with the corresponding solution spectrum.
...
The relatively poor resolution of the solid state \ce{^{13}C} NMR spectrum limits further analysis.
...
To conclusively demonstrate that there are two systems in the asymmetric unit we conducted a solid state \ce{^{77}Se} NMR experiment, which is shown in \ref{fig:cpmas-sol-77se}.

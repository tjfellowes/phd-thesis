...
We additionally performed a solid state IR experiment, which showed doubling of the carbonyl peak, confirming that there were indeed two distinct environments (\ref{fig:ss-ir-ebs-4ome}).

\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{Figures/ss-ir-ebs-4ome.eps}
    \caption{Solid state IR spectrum of \refcmpd{ebs.4ome}$\cdot$DMAP. The spectrum of the pure \refcmpd{ebs.4ome} (which contains only one molecule in the assymetric unit) is shown in gray. Splitting of the carbonyl peak is visible in the insert.}
    \label{fig:ss-ir-ebs-4ome}
\end{figure}

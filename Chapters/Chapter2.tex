...
Firstly, the signal moves to a lower energy as the \ce{C=O} bond loses some double bond character due to the delocalisation of the pyridine lone pair into the selenium heterocycle (\ref{fig:sigma-hole-delocalisation}).
...
\begin{figure}
    ...
    \caption{Solid state IR spectrum of \refcmpd{ebs.4oet}$\cdot$DMAP. The spectrum of the pure \refcmpd{ebs.4oet} (which contains only one molecule in the asymmetric unit) is shown in gray. Splitting of the carbonyl peak is visible in the insert.}

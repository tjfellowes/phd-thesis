...
\cmpdrow{ebs}{ebs.eps} \\
\refcmpd{ebs}\textbf{R} & \texttt{ebs.4R} & \vspace{0.4cm}\parbox[l]{4cm}{\centering\includegraphics[scale=0.6]{Figures/loc/ebs_r.eps}} \\
\cmpdrow{ebs.bn}{ebs_bn.eps} \\
\cmpdrow{ebs.h}{ebs_h.eps} \\
\refcmpd{ebs}$\cdot$\textbf{S} & \texttt{ebs.thio} & \vspace{0.4cm}\parbox[l]{4cm}{\centering\includegraphics[scale=0.6]{Figures/loc/ebs_thio.eps}} \\
...
\refcmpd{ebs-rhs-ph.pmb}$\cdot$\textbf{S} & \texttt{ebs-rhs-ph.thio-pmb} & \vspace{0.4cm}\parbox[l]{4cm}{\centering\includegraphics[scale=0.6]{Figures/loc/ebs-rhs-ph_thio-pmb.eps}} \\

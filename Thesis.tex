...
\newcommand{\cmpdrow}[2]{\refcmpd{#1} & \texttt{#1} & \parbox[c]{5cm}{\includegraphics[scale=0.6]{Figures/loc/#2}}}
...
\cmpdrow{ebs}{ebs.eps} \\
\refcmpd{ebs}\textbf{R} & \texttt{ebs.4R} & \parbox[c]{5cm}{\includegraphics[scale=0.6]{Figures/loc/ebs_r.eps}} \\

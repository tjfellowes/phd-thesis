...
\DeclareFieldFormat{doi}{%
  ...
  \mkbibacro{DOI}\addcolon\space
    \ifhyperref
      {\href{http://dx.doi.org/#1}{\footnotesize\nolinkurl{#1}}}
      {\footnotesize\nolinkurl{#1}}}

%% ----------------------------------------------------------------
\begin{document}

\labelcmpd[sub-counter-format=hammett]{ebs.4no2,ebs.4cn,ebs.4cf3,ebs.4br,ebs.4co2et,ebs.4me,ebs.4ome,ebs.4oet}
...
{
\textbf{Compound number} & \textbf{Compound code} & \textbf{Structure} \\
\cmpdrow{ebs}{ebs.eps} \\

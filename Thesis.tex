...
% Set up the document
\documentclass[a4paper, 12pt]{Thesis}  % Use the "Thesis" style, based on the ECS Thesis style by Steve Gunn
%
...
\setmarginsrb{3.7cm}  % left margin
             {1.5cm}  % top margin
             {3.0cm}  % right margin
             {3.0cm}  % bottom margin
             { 35pt}  % head height
...
\listofcompounds{ccc}  % Include a list of Abbreviations (a table of two columns)
{
